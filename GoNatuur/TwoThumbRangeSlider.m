...
#define kMinHandleDistance          20.0
...
@interface TwoThumbRangeSlider (PrivateMethods)
- (void)updateValues;
...
@implementation TwoThumbRangeSlider
...
- (void)resizeSliderFrame :(CGRect)aFrame minValue:(float)aMinValue maxValue:(float)aMaxValue barHeight:(float)height {
    ...
    self.minHandle = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"slide-arrow"] highlightedImage:[UIImage imageNamed:@"slide-arrow"]] autorelease];
    self.minHandle.center = CGPointMake(5, sliderBarHeight * 0.5);
    [self addSubview:self.minHandle];
    self.maxHandle = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"slide-arrow"] highlightedImage:[UIImage imageNamed:@"slide-arrow"]] autorelease];
...
- (void) drawRect:(CGRect)rect {
    ...
    CGContextSetFillColorWithColor(context, [UIColor colorWithRed:182.0/255.0 green:37.0/255.0 blue:70.0/255.0 alpha:1.0].CGColor);
