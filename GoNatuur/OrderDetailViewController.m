    ...
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            if (orderDataModel.fullShippingAddress == nil || [orderDataModel.fullShippingAddress[@"firstname"] isEqualToString:@""]) {
                ...
                return [DynamicHeightWidth getDynamicLabelHeight:[NSString stringWithFormat:@"%@ %@",orderDataModel.fullShippingAddress[@"firstname"],orderDataModel.fullShippingAddress[@"lastname"]] font:[UIFont montserratRegularWithSize:14] widthValue:_orderDetailTable.frame.size.width-20 heightValue:500] + [DynamicHeightWidth getDynamicLabelHeight:[orderDataModel.fullShippingAddress[@"street"] componentsJoinedByString:@" "] font:[UIFont montserratLightWithSize:13] widthValue:_orderDetailTable.frame.size.width-20 heightValue:500] + [DynamicHeightWidth getDynamicLabelHeight:[NSString stringWithFormat:@"%@ - %@, %@",orderDataModel.fullShippingAddress[@"city"],orderDataModel.fullShippingAddress[@"postcode"],orderDataModel.fullShippingAddress[@"region"]] font:[UIFont montserratLightWithSize:13] widthValue:_orderDetailTable.frame.size.width-20 heightValue:500] + [DynamicHeightWidth getDynamicLabelHeight:[NSString stringWithFormat:@"Phone Number: %@",orderDataModel.fullShippingAddress[@"telephone"]] font:[UIFont montserratLightWithSize:13] widthValue:_orderDetailTable.frame.size.width-20 heightValue:500] + 40;
            }
        } else if (indexPath.row == 1) {
            if (orderDataModel.fullBillingAddress == nil || [orderDataModel.fullBillingAddress[@"firstname"] isEqualToString:@""]) {
                return 0;
            } else {
                return [DynamicHeightWidth getDynamicLabelHeight:[NSString stringWithFormat:@"%@ %@",orderDataModel.fullBillingAddress[@"firstname"],orderDataModel.fullBillingAddress[@"lastname"]] font:[UIFont montserratRegularWithSize:14] widthValue:_orderDetailTable.frame.size.width-20 heightValue:500] + [DynamicHeightWidth getDynamicLabelHeight:[orderDataModel.fullBillingAddress[@"street"] componentsJoinedByString:@" "] font:[UIFont montserratLightWithSize:13] widthValue:_orderDetailTable.frame.size.width-20 heightValue:500] + [DynamicHeightWidth getDynamicLabelHeight:[NSString stringWithFormat:@"%@ - %@, %@",orderDataModel.fullBillingAddress[@"city"],orderDataModel.fullBillingAddress[@"postcode"],orderDataModel.fullBillingAddress[@"region"]] font:[UIFont montserratLightWithSize:13] widthValue:_orderDetailTable.frame.size.width-20 heightValue:500] + [DynamicHeightWidth getDynamicLabelHeight:[NSString stringWithFormat:@"Phone Number: %@",orderDataModel.fullBillingAddress[@"telephone"]] font:[UIFont montserratLightWithSize:13] widthValue:_orderDetailTable.frame.size.width-20 heightValue:500] + 35;
            }
        } else {
