...
- (void)CMSPageService:(NSString *)cmsPageType {
    ...
    [userLogin CMSPageService:^(LoginModel *userData) {
        ...
        if ([userData.cmsContent isEqualToString:@""] || userData.cmsContent==nil) {
            ...
            _noDataLabel.hidden=YES;
        [_aboutUsWebView loadHTMLString:[NSString stringWithFormat:@"<div style='text-align:justify; font-size:16px;font-family:Montserrat-Light;color:#000000;link:#B62546;'>%@", userData.cmsContent] baseURL: nil];
        }
