...
- (void)initialiseControl {
    ...
    self.sliderLineBetweenHandles.backgroundColor = [UIColor colorWithRed:182.0/255.0 green:37.0/255.0 blue:70.0/255.0 alpha:1.0].CGColor;
    ...
    if (self.minLabelColour == nil){
        self.minLabel.foregroundColor = [UIColor blackColor].CGColor;
    } else {
        self.minLabel.foregroundColor = [UIColor blackColor].CGColor;
    }
