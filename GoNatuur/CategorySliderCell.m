...
- (void)displaySliderItems:(NSString *)name isSelected:(BOOL)isSelected {
    ...
    if (isSelected) {
        ...
        self.contentView.backgroundColor=[UIColor colorWithRed:182.0/255.0 green:37.0/255.0 blue:70.0/255.0 alpha:1.0];
        _categoryName.textColor=[UIColor whiteColor];
    }
    else {
         [self.contentView setBorder:self.contentView color:[UIColor colorWithRed:182.0/255.0 green:37.0/255.0 blue:70.0/255.0 alpha:1.0] borderWidth:2.0];
        self.contentView.backgroundColor=[UIColor clearColor];
        _categoryName.textColor=[UIColor colorWithRed:182.0/255.0 green:37.0/255.0 blue:70.0/255.0 alpha:1.0];
    }
}
#pragma mark - end
@end
